       ...
       WITHDRAW.
           ...
           ELSE
              ...
              PERFORM UPDATE-ACCOUNT
              PERFORM GENERATE-SLIP-WITHDRAW
       ...
       TRANSFER.
           ...
           ELSE
              ...
              IF DES-ACC-FOUND = "Y"
                 ...
                 PERFORM GENERATE-SLIP-TRANSFER
       ...
       WRITE-SLIP-HEADER.
           ...
           SLIP-REC
           WRITE SLIP-REC
           MOVE "   *** GEMINI BANK TRANSACTION SLIP ***" TO SLIP-REC
           WRITE SLIP-REC
           MOVE "--------------------------------------------" TO
           SLIP-REC
           WRITE SLIP-REC
